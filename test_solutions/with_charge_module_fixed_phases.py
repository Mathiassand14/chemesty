...
# Create the reaction with explicit phases
from chemesty.reactions.reaction import Reaction
reaction = Reaction()
reaction.add_reactant(fe2_aq, phase=aq)
reaction.add_reactant(ce4_aq, phase=aq)
reaction.add_product(fe3_aq, phase=aq)
reaction.add_product(ce3_aq, phase=aq)
